...
const Player = ({ gameState }) => {
  return (
    <div className='m-10 p-4  rounded-xl flex flex-row gap-10 items-start justify-start'>
      <div className='p-2 rounded-md bg-violet-500 h-[200px]'>
        {' '}
        <div className='font-bold text-lg pb-1  flex flex-row gap-2'>
          <p>Click</p> <div className='px-2 bg-black w-fit rounded-sm'>1</div>{' '}
          <p>to Select P1</p>
        </div>
        <div className='font-bold text-lg pb-1  flex flex-row gap-2'>
          <p>Click</p> <div className='px-2 bg-black w-fit rounded-sm'>2</div>{' '}
          <p>to Select P2</p>
        </div>
        <div className='font-bold text-lg pb-1  flex flex-row gap-2'>
          <p>Click</p> <div className='px-2 bg-black w-fit rounded-sm'>3</div>{' '}
          <p>to Select P3</p>
        </div>
        <div className='font-bold text-lg pb-1  flex flex-row gap-2'>
          <p>Click</p> <div className='px-2 bg-black w-fit rounded-sm'>4</div>{' '}
          <p>to Select H1</p>
        </div>
        <div className='font-bold text-lg pb-1  flex flex-row gap-2'>
          <p>Click</p> <div className='px-2 bg-black w-fit rounded-sm'>5</div>{' '}
          <p>to Select H2</p>
        </div>
        <div className='font-bold text-lg pb-1  flex flex-row gap-2'>
          <div>press</div>
      ...
      <div className='p-2 rounded-md bg-violet-500 flex flex-col font-bold text-lg pb-1 gap-2 h-[200px]'>
